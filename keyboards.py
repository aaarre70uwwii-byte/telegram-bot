...
ADMIN_MARKUP = ReplyKeyboardMarkup(ADMIN_KEYBOARD, resize_keyboard=True, selective=True)
...
SETTINGS_MARKUP = ReplyKeyboardMarkup(SETTINGS_KEYBOARD, resize_keyboard=True, selective=True)
...
LOCK_MARKUP = ReplyKeyboardMarkup(LOCK_KEYBOARD, resize_keyboard=True, selective=True)
...
FUN_MARKUP = ReplyKeyboardMarkup(FUN_KEYBOARD, resize_keyboard=True, selective=True)
...
DEV_MARKUP = ReplyKeyboardMarkup(DEV_KEYBOARD, resize_keyboard=True, selective=True)
...
SERVICE_MARKUP = ReplyKeyboardMarkup(SERVICE_KEYBOARD, resize_keyboard=True, selective=True)
